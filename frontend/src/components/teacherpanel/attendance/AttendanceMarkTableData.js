...
const AttendanceTableData = ({
  ...
  if (
    ...
    Object.prototype.hasOwnProperty.call(studentsData, "students_for_attendance")
  ) {
...
AttendanceTableData.propTypes = {
  attendanceClassDetails: PropTypes.shape({
    grade: PropTypes.number.isRequired,
    subject: PropTypes.string.isRequired,
  }).isRequired,
  fetchStudents: PropTypes.bool.isRequired,
